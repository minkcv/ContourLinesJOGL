    ...
    public void display(GLAutoDrawable drawable) 
    {
      ...
      switch(cmd)
        ...
        case SELECT:
          ...
          IntBuffer selectBuffer = GLBuffers.newDirectIntBuffer(buffsize);
          int hits = 0;
          gl.glGetIntegerv(GL.GL_VIEWPORT, viewPort, 0);
          //Uncomment to see sieze of the viewport
          System.out.println("vp[0]="+viewPort[0]+" vp[1]="+viewPort[1]+" vp[2]="+viewPort[2]+" vp[3]="+viewPort[3]);
